...
DROP TABLE IF EXISTS BOC_TUTORIAL_RULESETS ;
DROP TABLE IF EXISTS BOC_TUTORIAL_COMMENTS ;
DROP TABLE IF EXISTS BOC_TUTORIAL_MOVES ;
DROP TABLE IF EXISTS BOC_TUTORIALS ;
...
DROP TABLE IF EXISTS BOC_USER_BOARD_RELATIONSHIPS;
...
-- -----------------------------------------------------
-- Table BOC_USER_BOARD_RELATIONSHIPS
-- -----------------------------------------------------

CREATE TABLE BOC_USER_BOARD_RELATIONSHIPS (
...
CREATE INDEX idx_BOC_USER_BOARD_RELATIONSHIPS_USER ON BOC_USER_BOARD_RELATIONSHIPS (USERNAME);
...
CREATE TABLE IF NOT EXISTS BOC_TUTORIALS (
  TUTORIAL_ID INTEGER PRIMARY KEY,
  BOARD_ID INT NOT NULL,
  AUTHOR TEXT NOT NULL,
  STATUS TEXT NULL,
  OUTCOME TEXT NULL,
  D_CREATED TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  D_CHANGED TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_BOC_TUTORIALS_BOC_BOARDS1
    FOREIGN KEY (BOARD_ID)
    REFERENCES BOC_BOARDS (BOARD_ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_BOC_TUTORIALS_BOC_USER1
    FOREIGN KEY (AUTHOR)
    REFERENCES BOC_USER (USERNAME)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE INDEX fk_BOC_TUTORIALS_BOC_BOARDS1_idx ON BOC_TUTORIALS (BOARD_ID ASC);

CREATE INDEX fk_BOC_TUTORIALS_BOC_USER1_idx ON BOC_TUTORIALS (AUTHOR ASC);


-- -----------------------------------------------------
-- Table BOC_TUTORIAL_MOVES
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS BOC_TUTORIAL_MOVES (
  TUTORIAL_ID INT NOT NULL,
  TURN_INDEX INT NOT NULL,
  PLAYER INT NOT NULL,
  REPRESENTATION TEXT NULL,
  PRIMARY KEY (TUTORIAL_ID, TURN_INDEX, PLAYER),
  CONSTRAINT fk_BOC_TUTORIAL_MOVES_BOC_TUTORIALS1
    FOREIGN KEY (TUTORIAL_ID)
    REFERENCES BOC_TUTORIALS (TUTORIAL_ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);

-- -----------------------------------------------------
-- Table BOC_TUTORIAL_COMMENTS
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS BOC_TUTORIAL_COMMENTS (
  TUTORIAL_ID INT NOT NULL,
  TURN_INDEX INT NOT NULL,
  TUTORIAL_COMMENT TEXT,
  PRIMARY KEY (TUTORIAL_ID, TURN_INDEX),
  CONSTRAINT fk_BOC_TUTORIAL_COMMENTS_BOC_TUTORIALS1
    FOREIGN KEY (TUTORIAL_ID)
    REFERENCES BOC_TUTORIALS (TUTORIAL_ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
-- -----------------------------------------------------
-- Table BOC_TUTORIAL_RULESETS
-- -----------------------------------------------------

CREATE TABLE IF NOT EXISTS BOC_TUTORIAL_RULESETS (
  TUTORIAL_ID INT NOT NULL,
  RULE_GROUP TEXT NOT NULL,
  RULE TEXT,
  PRIMARY KEY (TUTORIAL_ID, RULE_GROUP),
  CONSTRAINT fk_BOC_TUTORIAL_RULESETS_BOC_TUTORIALS1
    FOREIGN KEY (TUTORIAL_ID)
    REFERENCES BOC_TUTORIALS (TUTORIAL_ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_BOC_TUTORIAL_RULESETS_BOC_RULEGROUPS1
    FOREIGN KEY (RULE_GROUP)
    REFERENCES BOC_RULEGROUPS (RULE_GROUP)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_BOC_TUTORIAL_RULESETS_BOC_RULES1
    FOREIGN KEY (RULE)
    REFERENCES BOC_RULES (RULE)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
...
CREATE INDEX fk_BOC_TUTORIAL_RULESETS_BOC_RULEGROUPS1_idx ON BOC_TUTORIAL_RULESETS (RULE_GROUP ASC);

CREATE INDEX fk_BOC_TUTORIAL_RULESETS_BOC_RULES1_idx ON BOC_TUTORIAL_RULESETS (RULE ASC);
...
CREATE TABLE IF NOT EXISTS BOC_HOUSEKEEPING_LOGS (
  ...
  D_EARLIEST_RECALC TIMESTAMP DEFAULT NULL,
  TIME_TAKEN INT,
  GAMES_AFFECTED INT,
  USERS_AFFECTED INT,
  BOARDS_AFFECTED INT,
