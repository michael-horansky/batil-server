...
INSERT INTO BOC_RULES VALUES( 'one_hour_cumulative', 'deadline', 'When opening the game and being prompted for a new turn, a timer starts. Its value is added to a cumulative sum after the full turn is submitted. If this sum exceeds one hour, the player automatically loses the game.', 2, '', '', 'One hour, cummulative' );
INSERT INTO BOC_RULES VALUES( 'one_day_cumulative', 'deadline', 'When opening the game and being prompted for a new turn, a timer starts. Its value is added to a cumulative sum after the full turn is submitted. If this sum exceeds one day, the player automatically loses the game.', 3, '', '', 'One day, cummulative' );
